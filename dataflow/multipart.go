...
func NewMultipartHelper() MultipartDataflow {
	df := MultipartDf{}
...
func (m *MultipartDf) Boundary(b string) MultipartDataflow {
...
func (m *MultipartDf) FileByPath(fieldName string, filePath string) MultipartDataflow {
...
func (m *MultipartDf) FileMem(fieldName string, fileName string, reader io.Reader) MultipartDataflow {
	writer, err := m.mWriter.CreateFormFile(fieldName, fileName)
	if err != nil {
		m.errs = append(m.errs, errors.Wrap(err, "create file part failed"))
	}
...
func (m *MultipartDf) Part(header textproto.MIMEHeader, reader io.Reader) MultipartDataflow {
...
func (m *MultipartDf) FieldValue(fieldName string, value string) MultipartDataflow {
...
func (m *MultipartDf) Field(fieldName string, reader io.Reader) MultipartDataflow {
